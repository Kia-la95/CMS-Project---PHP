    ...
    <div class="container">
        ...
        <div class="row">
            ...
            if(isset($_GET['p_id'])){
             ...
             $set_view_count = mysqli_query($connection, $view_query);
            ...
            if(mysqli_num_rows($select_all_posts_query) < 1){
                ...
                echo "<br>";
                echo "<h1 class='text-center'>No Posts Avaialble</h1>";
            }else{
            ...
            <!-- Blog Comments, Inserting comments into the Database after clicking submit -->
                ...
                <!-- Posted Comments -->
                <!-- Showing comments based on the newest ones, getting info from database
                and echo them in the div class below to show them in order. The comments
                must be approved to be shown under each post -->
                <?php
