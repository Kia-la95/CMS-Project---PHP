...
<table class="table table-bordered table-hover">
                ...
                while ($row = mysqli_fetch_assoc($select_comments)){ // row is like a database here, we can use it to get data from each coloumn
                    ...
                    echo "<td><a href='comments.php?approve=$comment_id&id=" .$_GET['p_id'] ."'>Approve</a></td>";
                    echo "<td><a href='comments.php?unapprove=$comment_id&id=" .$_GET['p_id'] ."'>Unapprove</a></td>";
...
if(isset($_GET['approve'])){
    ...
    header("Location: post_comments.php?id=". $_GET['p_id'] ."");
