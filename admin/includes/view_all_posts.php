...
<table class="table table-bordered table-hover">
    ...
    <div class="col-xs-4">
        ...
        <a class="btn btn-primary" href="posts.php?source=add_post">Add New</a>
                ...
                // We are joining 2 tables from the databse together, adn we use LEFT JOIN, because the posts table is our main one
                ...
                while ($row = mysqli_fetch_assoc($select_posts)){ // row is like a database here, we can use it to get data from each coloumn
                    $post_id = $row['post_id'];
                    $post_author = $row['post_author'];
                    $post_title = $row['post_title'];
                    $post_user = $row['post_user'];
                    ...
                    echo "<td><a href='../post.php?p_id=$post_id'><img width=100px; src='../images/$post_image'></a></td>";
